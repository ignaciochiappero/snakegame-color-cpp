...
void gotoxy(int x, int y){
	...
	void setcursor(bool visible, DWORD size) // establecer bool visible = 0 - invisible, bool visible = 1 - visible
	{
		if(size == 0)
		{
			size = 20;	// tamaño de cursor predeterminado Cambiar a números de 1 a 20, disminuye el ancho del cursor
		}
	...
	private:
		...
		int size; // tamaño actual de la serpiente
		char dir; // dirección actual de la serpiente
		Point fruit;
	...
	public:
		Snake() {
			size = 1; // tamaño predeterminado
			cell[0] = new Point(20, 20); // 20,20 es la posición predeterminada
